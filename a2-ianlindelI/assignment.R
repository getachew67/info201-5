...
has_more_zs <- function(str1, str2) {
  ...
  if (zs_in_2 == 0 & zs_in_1 == 0) {
    ...
    sentence <- paste("The strings have the same number of Zs.")
...
more_zs <- has_more_zs("myz namez isz ianz", "that was wrong")
...
remove_digits(c("INFO 201", "CSE142"))
...
movies <- c(
  ...
  "Gardians of the Galaxy", "Good Will Hunting", "The Incredibles"
)
